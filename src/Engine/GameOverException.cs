...
namespace Dgt.Minesweeper.Engine
{
    ...
    public class GameOverException : Exception
    {
        ...
        // I'm not sure if I want to keep these. This exception doesn't really make sense without the IsWon property
        // being set. However, Microsoft best practices recommend having these, and they are based off code that is
        // generated by Visual Studio when generating a custom exception class.
        //
